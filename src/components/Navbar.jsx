        ...
        <div className="nav-actions">
          ...
          <div className="nav-dropdown-wrap">
            ...
            <div className="nav-dropdown-menu">
              ...
              >
                <img src="/icons/chrome.svg" width="18" height="18" alt="Google Chrome" />
                <div className="nav-dropdown-text">
                  <span className="nav-dropdown-title">Chrome Web Store</span>
                  <span className="nav-dropdown-sub">Chrome, Brave, Edge</span>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div className="nav-dropdown-text">
                  <span className="nav-dropdown-title">Firefox Add-ons</span>
                  <span className="nav-dropdown-sub">Official AMO Store</span>
                </div>
              </a>
            </div>
          </div>
